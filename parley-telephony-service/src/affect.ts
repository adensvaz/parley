...
function toSamples(buf: Buffer, enc: "linear16" | "mulaw"): Int16Array {
...
function extractFeatures(s: Int16Array, sr: number): AcousticFeatures {
...
function dspAffect(f: AcousticFeatures): Affect {
  const n = norm(f);
