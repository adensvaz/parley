// parley-analytics-service — Call scoring, rollups, manager dashboards
// Bounded context owns: analytics schema
// Subscribes: call.ended,objection.fired   |   Publishes: -
...
async function main() {
  await bus();
  // TODO: subscribe to [call.ended,objection.fired], publish [-] via the transactional outbox relay.
